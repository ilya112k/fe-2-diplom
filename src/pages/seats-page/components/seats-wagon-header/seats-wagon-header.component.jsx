...
import "./seats-wagon-header.component.css";

function SeatsWagonHeaderComponent({ data, identity, wagonClass }) {
    ...
    return (
        <div className="seats__wagon-details-header" id={`wagon-names-${identity}`}>
            ...
            <div className="wagon-details__list">
                {
                    data && data.map(item => identity === "departure" && item.coach.class_type === wagonClass.depClass ?
                        <button
                ...
                {
                    data && data.map(item => identity === "arrival" && item.coach.class_type === wagonClass.arrClass ?
                        <button
                            className="wagon-details__item"
                            type="button"
                            key={item.coach._id}
...
export default SeatsWagonHeaderComponent;

SeatsWagonHeaderComponent.propTypes = {
