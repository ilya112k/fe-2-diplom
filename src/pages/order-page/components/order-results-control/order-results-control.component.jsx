...
import "./order-results-control.component.css";

function OrderResultsControlComponent({ count, onChange }) {
...
export default OrderResultsControlComponent;

OrderResultsControlComponent.propTypes = {
