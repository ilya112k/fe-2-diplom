...
import SliderPriceComponent from "../../../../components/slider-price/slider-price.component";
import SliderPeriodComponent from "../../../../components/slider-period/slider-period.component";
import SidebarSwitchComponent from "../../../../components/sidebar-switch/sidebar-switch.component";

import "./order-filters.component.css";
    ...
    return (
        <div className="order-filters filter">
            ...
            <div className="filter__date">
                <fieldset className="filter__fieldset">
                    ...
                    <div className="fieldset__input-wrapper">
                        ...
                        <CalendarComponent name={"fieldset__input-thither"}
                ...
                <fieldset className="filter__fieldset">
                    ...
                    <div className="fieldset__input-wrapper">
                        <label className="fieldset__label" />
                        <CalendarComponent name={"fieldset__input-back"}
                    ...
                    return (
                        <div className="switch__component" key={item.name}>
                            <div className="switch__image">
                                <SVGIconComponent name={item.name} />
                            </div>
                            <span className="switch__title">{item.alt}</span>
                            <SidebarSwitchComponent name={item.name} onChange={handleClickSwitch} />
                        </div>
                    )
                })
                }
            ...
            <div className="filter__price price">
                ...
                <SliderPriceComponent onChange={handlePrice} />
            </div>
            ...
            <div className="filter__period period-departure">
                <div className="filter__period-control">
                    ...
                    <div className="filter__period-content">
                        ...
                        <SliderPeriodComponent data={{ from: 0, to: 24 }} name={"start_departure"} onChange={handleTimePeriod} />
                        <p className="filter__period-subtitle departure-subtitle-right">Время прибытия</p>
                        <SliderPeriodComponent data={{ from: 0, to: 24 }} name={"start_arrival"} onChange={handleTimePeriod} />
                    </div>
                </div>
            </div>
            ...
            <div className="filter__period period-arrival">
                <div className="filter__period-control">
                    ...
                    <div className="filter__period-content">
                        ...
                        <SliderPeriodComponent data={{ from: 0, to: 24 }} name={"end_departure"} onChange={handleTimePeriod} />
                        <p className="filter__period-subtitle arrival-subtitle-right">Время прибытия</p>
                        <SliderPeriodComponent data={{ from: 0, to: 24 }} name={"end_arrival"} onChange={handleTimePeriod} />
                    </div>
                </div>
            </div>
