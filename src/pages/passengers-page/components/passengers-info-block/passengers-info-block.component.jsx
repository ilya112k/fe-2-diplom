...
import "./passengers-info-block.component.css";

function PassengersInfoBlockComponent({ number, onChange }) {
...
export default PassengersInfoBlockComponent;

PassengersInfoBlockComponent.propTypes = {
